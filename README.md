...
A comprehensive Python GUI tool implementing classical encryption algorithms like Vigenere, Playfair, Caesar, and Hill.
# ==========================================
# المطور: يحيى مجاهد صالح شالف
# Developer: Yahya Mujahed Saleh Shalef
# المشروع: أداة خوارزميات التشفير الكلاسيكية
# ==========================================
